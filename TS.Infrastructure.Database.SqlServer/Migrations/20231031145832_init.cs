    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Seller_Medal_MedalId",
                        column: x => x.MedalId,
                        principalTable: "Medal",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Seller_Picture_PictureId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShopStand", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ShopStand_Picture_PictureId",
                        column: x => x.PictureId,
                        principalTable: "Picture",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ShopStand_Seller_sellerId",
                        column: x => x.sellerId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SellerId = table.Column<int>(type: "int", nullable: false),
                    PictureId = table.Column<int>(type: "int", nullable: false),
                    ShopStandId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Product_ShopStand_ShopStandId",
                        column: x => x.ShopStandId,
                        principalTable: "ShopStand",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuctionPrice", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AuctionPrice_Product_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductCustomAttribute_CustomAttribute_AttributeId",
                        column: x => x.AttributeId,
                        principalTable: "CustomAttribute",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductCustomAttribute_Product_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Product",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuctionInformation", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AuctionInformation_AuctionPrice_AuctionPriceId",
                        column: x => x.AuctionPriceId,
                        principalTable: "AuctionPrice",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AuctionInformation_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductInventory_Order_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Order",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomAttribute_CategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductCustomAttribute_AttributeId",
                table: "ProductCustomAttribute",
                column: "AttributeId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductCustomAttribute_ProductId",
                table: "ProductCustomAttribute",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductInventory_OrderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShopStand_PictureId",
                table: "ShopStand",
                column: "PictureId");

            migrationBuilder.CreateIndex(
                name: "IX_ShopStand_sellerId",
                table: "ShopStand",
                column: "sellerId",
                unique: true);
