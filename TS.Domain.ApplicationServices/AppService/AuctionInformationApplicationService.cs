...
{
    public class AuctionInformationApplicationService : IAuctionInformationApplicationService
    {
        private readonly IAuctionInformationApplicationService _auctionInformationService;
        public AuctionInformationApplicationService(IAuctionInformationApplicationService auctionInformationService)
        {
