...
{
    public class ProductCustomAttributeApplicationService : IProductCustomAttributeApplicationService
    {
        private readonly IProductCustomAttributeApplicationService _productCustomAttributeService;
        public ProductCustomAttributeApplicationService(IProductCustomAttributeApplicationService productCustomAttributeService)
        {
